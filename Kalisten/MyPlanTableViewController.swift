...
class MyPlanTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        trainingButton.backgroundColor = UIColor(red: 37.0/255.0, green: 116.0/255.0, blue: 169.0/255.0, alpha: 1.0)
        nutriGoalButton.backgroundColor = UIColor(red: 37.0/255.0, green: 116.0/255.0, blue: 169.0/255.0, alpha: 1.0)
